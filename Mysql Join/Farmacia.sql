 create database db_farmacia_sp;
     use db_farmacia_sp;
    ...
    insert into tb_categoria (receita, tipo_produto, publico_alvo) values (true, "Medicamento Restrito","Adulto");
	insert into tb_categoria (receita, tipo_produto, publico_alvo) values (true, "Medicamento Restrito","Infantil");
	insert into tb_categoria (receita, tipo_produto, publico_alvo) values (false, "Cosméticos","Adulto"); 
	insert into tb_categoria (receita, tipo_produto, publico_alvo) values (false, "Cosméticos","Adulto");
	insert into tb_categoria (receita, tipo_produto, publico_alvo) values (false, "Higiene Pessoal","Adulto");
	insert into tb_categoria (receita, tipo_produto, publico_alvo) values (false, "Higiene Pessoal","Infantil");
